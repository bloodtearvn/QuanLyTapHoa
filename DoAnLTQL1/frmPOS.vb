...
Public Class frmPOS
    ...
    Private Function isAvailableQuantity() As Boolean
        Try
            ...
            If dr.Read = True Then
                ...
                Else
                    MsgBox("Tồn kho không đủ số lượng", MsgBoxStyle.Critical, "Kiểm tra tồn kho")
                    txtSearch.Clear()
                End If
            End If
        Catch ex As Exception
    ...
    Private Sub DeletePOSDetail()
        Try
            ...
            If i > 0 Then
                MsgBox("Đã xóa hàng hóa", MsgBoxStyle.Information, "Xóa hàng hóa")
            Else
                MsgBox("Không thể xóa hàng hóa", MsgBoxStyle.Critical, "Xóa hàng hóa")
            End If
        Catch ex As Exception
            MsgBox(ex.Message)
        Finally
    ...
    Private Sub frmPOS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Label5.Text = GetFullName(Convert.ToInt32(frmMain.lblEmployeeNo.Text))
        GetInvoiceNo()
    ...
    Private Sub btnDiscount_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDiscount.Click
        ...
        percentDiscount = InputBox("Nhập số phần trăm miễn giảm", "Miễn giảm")
    ...
    Private Sub btnRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemove.Click
        If dgw.Rows.Count = 0 Then
            MsgBox("Không có hóa đơn", MsgBoxStyle.Exclamation, "Xóa hàng hóa")
            txtSearch.Focus()
            Exit Sub
        Else
            If MsgBox("Bạn có chắc chắn xóa?", MsgBoxStyle.YesNo, "Xóa hàng hóa") = MsgBoxResult.Yes Then
                RemoveItem()
                txtSearch.Focus()
            Else
                Exit Sub
    ...
    Private Sub btnPayment_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPayment.Click
        If Me.lblCustomerName.Text = "Khách vãng lai" Then
            MsgBox("Vui lòng chọn khách hàng! ", MsgBoxStyle.Information, "Thanh toán")
        Else
            frmPayment.Show()
        End If
    End Sub
